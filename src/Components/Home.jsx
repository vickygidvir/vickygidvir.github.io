	...
	return (
		<section id="home">
			<div className='h-screen flex flex-col items-center lg:justify-around relative'>
				<IoMenu onClick={toggleMenu} className={` text-white absolute top-5 left-6 cursor-pointer lg:hidden ${menuOpen ? 'hidden' : 'block'}`} size={35} />
				...
				<div data-aos="zoom-in-up" data-aos-delay="800" className='flex flex-col items-center gap-2'>
					...
					<span className='border-2 border-white w-5 h-7 rounded-2xl relative'>
						<a href="#about" className='w-1 h-1 bg-white absolute rounded-full top-3 left-1.5 animate-mouse-wheel'></a>
					</span>
				</div>
			</div>
		</section>

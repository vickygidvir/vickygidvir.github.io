		...
		<section id="contact">
			<div className='container relative my-32'>
				...
				<div className='flex'>
					...
					<div  data-aos="fade-up" data-aos-delay={'400'} className='flex flex-col gap-3 w-[60%] bg-[url("https://jthemes.net/themes/html/bolby/demo/images/map-light.png")] bg-no-repeat'>
					...
					<div  data-aos="fade-down" data-aos-delay={'500'} className='flex flex-col gap-10 w-full'>
